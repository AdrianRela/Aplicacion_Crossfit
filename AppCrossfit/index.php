...
$router->map( 'GET', '/AppCrossfit/admin', function() {
    AdminController::index();
});
$router->map( 'POST', '/AppCrossfit/admin', function() {
    AdminController::index();
});
$router->map( 'POST', '/AppCrossfit/admin-actualiza', function() {
    AdminController::actualizarAdmin();
});
$router->map( 'POST', '/AppCrossfit/admin-insertar', function() {
    AdminController::insertarAdmin();
});
...
$router->map('GET',"/AppCrossfit/api/ids", function() {
    APIController::IdsConsulta();
});
